...
public final class DaggerMusicWallApp_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends MusicWallApp_HiltComponents.SingletonC {
    ...
    dagger.internal.Provider<WallpaperRefreshWorker_AssistedFactory> wallpaperRefreshWorker_AssistedFactoryProvider;

    dagger.internal.Provider<LastFmService> provideLastFmServiceProvider;
    ...
    Map<String, Provider<WorkerAssistedFactory<? extends ListenableWorker>>> mapOfStringAndProviderOfWorkerAssistedFactoryOf(
        ) {
      return Collections.<String, Provider<WorkerAssistedFactory<? extends ListenableWorker>>>singletonMap("com.jfcardenas.musicwall.worker.WallpaperRefreshWorker", ((dagger.internal.Provider) (wallpaperRefreshWorker_AssistedFactoryProvider)));
    }
